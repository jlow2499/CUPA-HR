...
body <- dashboardBody(
  tabItems(
    ...
    tabItem(tabName="Description",
            fluidRow(box(width=6,"Plot one is intended to explore Tenure of the academic staff versus the median salary. 
                                  ...
                                  Mid-Level Officials, 
                                  and Professors."),
                box(width=6,"The third tab of Plot one is used for an interactive data table. 
                             The data table can be exported as a CSV, 
                             copied to your clipboard, or printed if needed.")),
            fluidRow(
                box(width=12,"Plot one has three features that make the plot more user friendly than most plotting packages. 
    ...
    tabItem(tabName="description2",
            fluidRow(box(width=6,"Plot two is intended to explore NCAA Division by Median Salary faceted by job category. 
            ...
            fluidRow(box(width=6,"Plot two uses ggplot two wrapped in plot.ly which makes it interactive.
    ...
    tabItem(tabName="description3",
            fluidRow(box(width=6,"Plot three was created to allow the user to fully control what plot they are building 
                         from the data set. 
                     ...
                     box(width=6,"Simply use the radio buttons at the top of the plot to control what varialbes the plot outputs. 
